const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      'assets/index.CjbndfYQ.js',
      'assets/educational.DGcpwyjM.js',
      'assets/educational.C1b2MjXg.css',
      'assets/index.BJbYSw9h.css',
      'assets/index.C3aBnMRy.js',
      'assets/index.h3fyQTBv.css',
    ]),
) => i.map((i) => d[i])
;(function () {
...
const X = {},
  ...
  xr = (e) => (te(e) || B(e)) && B(e.then) && B(e.catch),
...
function Pr(e) {
  ...
  for (; s; ) {
    const r = s.prevDep
    ;(s.version === -1 ? (s === n && (n = r), ds(s), eo(s)) : (t = s),
...
function Tr(e) {
  if (
    ...
    ((e.globalVersion = $t), !e.isSSR && e.flags & 128 && ((!e.deps && !e._dirty) || !Kn(e)))
  )
    return
  e.flags |= 2
  const t = e.dep,
...
function qe(e, t, n, s, r, i) {
  ...
  if ((us(), t === 'clear')) o.forEach(l)
    ...
    if (c && n === 'length') {
      const u = Number(s)
      o.forEach((d, g) => {
        ;(g === 'length' || g === Jt || (!It(g) && g >= u)) && l(d)
      })
    } else
      switch (((n !== void 0 || o.has(void 0)) && l(o.get(n)), h && l(o.get(Jt)), t)) {
        case 'add':
          c ? h && l(o.get('length')) : (l(o.get(gt)), Bt(e) && l(o.get(qn)))
          break
        case 'delete':
          c || (l(o.get(gt)), Bt(e) && l(o.get(qn)))
          break
        case 'set':
          Bt(e) && l(o.get(gt))
          break
...
const no = {
  __proto__: null,
  [Symbol.iterator]() {
    return Mn(this, Symbol.iterator, (e) => tt(this, e))
  },
  concat(...e) {
    return bt(this).concat(...e.map((t) => (V(t) ? bt(t) : t)))
  },
  entries() {
    return Mn(this, 'entries', (e) => ((e[1] = tt(this, e[1])), e))
  },
  every(e, t) {
    return Ge(this, 'every', e, t, void 0, arguments)
  },
  filter(e, t) {
    return Ge(this, 'filter', e, t, (n) => n.map((s) => tt(this, s)), arguments)
  },
  find(e, t) {
    return Ge(this, 'find', e, t, (n) => tt(this, n), arguments)
  },
  findIndex(e, t) {
    return Ge(this, 'findIndex', e, t, void 0, arguments)
  },
  findLast(e, t) {
    return Ge(this, 'findLast', e, t, (n) => tt(this, n), arguments)
  },
  findLastIndex(e, t) {
  ...
  values() {
    return Mn(this, 'values', (e) => tt(this, e))
  },
}
function Mn(e, t, n) {
  const s = ps(e),
...
function Dn(e, t, n) {
  ...
  oe(s, 'iterate', Jt)
  const r = s[t](...n)
  return (r === -1 || r === !1) && _s(n[0]) ? ((n[0] = q(n[0])), s[t](...n)) : r
}
function Dt(e, t, n = []) {
  ;($e(), us())
...
const ro = rs('__proto__,__v_isRef,__isVue'),
  Mr = new Set(
...
class Dr {
  ...
  get(t, n, s) {
    ...
    if (n === '__v_raw')
      return s === (r ? (i ? mo : Br) : i ? Hr : Fr).get(t) ||
    ...
    if ((It(n) ? Mr.has(n) : ro(n)) || (r || oe(t, 'get', n), i)) return l
    if (ce(l)) {
      const c = o && ls(n) ? l : l.value
      return r && te(c) ? $n(c) : c
    }
    return te(l) ? (r ? $n(l) : An(l)) : l
  }
}
class Lr extends Dr {
  constructor(t = !1) {
  ...
  set(t, n, s, r) {
    ...
    return (t === q(r) && (l ? ot(s, i) && qe(t, 'set', n, s) : qe(t, 'add', n, s)), c)
  }
  deleteProperty(t, n) {
    const s = k(t, n)
    t[n]
  ...
  has(t, n) {
    ...
    return ((!It(n) || !Mr.has(n)) && oe(t, 'has', n), s)
  }
  ownKeys(t) {
...
function uo(e, t, n) {
  return function (...s) {
    const r = this.__v_raw,
      ...
      u = n ? kn : t ? zt : ze
    return (
      !t && oe(i, 'iterate', c ? qn : gt),
      {
        next() {
          const { value: d, done: g } = h.next()
          return g ? { value: d, done: g } : { value: l ? [u(d[0]), u(d[1])] : u(d), done: g }
        },
        [Symbol.iterator]() {
          return this
        },
  ...
  const n = {
    ...
    forEach(r, i) {
      const o = this,
        ...
        c = q(l),
        h = t ? kn : e ? zt : ze
      return (!e && oe(c, 'iterate', gt), l.forEach((u, d) => r.call(i, h(u), h(d), o)))
    },
  }
  return (
    fe(
      ...
      e
        ...
        : {
            add(r) {
              !t && !Ce(r) && !lt(r) && (r = q(r))
              const i = q(this)
              return (nn(i).has.call(i, r) || (i.add(r), qe(i, 'add', r, r)), this)
            },
            set(r, i) {
              !t && !Ce(i) && !lt(i) && (i = q(i))
              const o = q(this),
              ...
              const u = c.call(o, r)
              return (o.set(r, i), h ? ot(i, u) && qe(o, 'set', r, i) : qe(o, 'add', r, i), this)
            },
            delete(r) {
              const i = q(this),
                { has: o, get: l } = nn(i)
...
function An(e) {
  return lt(e) ? e : ms(e, !1, lo, ho, Fr)
}
function Vr(e) {
  return ms(e, !1, fo, po, Hr)
}
function $n(e) {
  return ms(e, !0, co, go, Br)
}
...
function yo(e) {
  return (!k(e, '__v_skip') && Object.isExtensible(e) && Rr(e, '__v_skip', !0), e)
}
...
class Ao {
  ...
  notify() {
    if (((this.flags |= 16), !(this.flags & 8) && Y !== this)) return (wr(this, !0), !0)
  }
  get value() {
...
function wo(e, t, n = X) {
  ...
  const j = Zi(),
    N = () => {
      ;(u.stop(), j && j.active && os(j.effects, u))
    }
  if (i && t) {
    const I = t
    t = (...z) => {
  ...
  let T = P ? new Array(e.length).fill(rn) : rn
  const L = (I) => {
    if (!(!(u.flags & 1) || (!u.dirty && !I)))
      if (t) {
        const z = u.run()
        if (r || w || (P ? z.some((ie, Z) => ot(ie, T[Z])) : ot(z, T))) {
          g && g()
          const ie = ht
          ht = u
          try {
            const Z = [z, T === rn ? void 0 : P && T[0] === rn ? [] : T, m]
            ;((T = z), c ? c(t, 3, Z) : t(...Z))
          } finally {
            ht = ie
          }
  ...
  return (
    ...
    t ? (s ? L(!0) : (T = u.run())) : o ? o(L.bind(null, !0), !0) : u.run(),
...
function kr(e) {
  try {
    ...
    ;((Fe = -1), (de.length = 0), qr(), (dn = null), (de.length || Ct.length) && kr())
  }
}
let Ae = null,
  $r = null
function hn(e) {
  const t = Ae
  return ((Ae = e), ($r = (e && e.type.__scopeId) || null), t)
}
...
function Gt(e, t, n, s, r = !1) {
  if (V(e)) {
    e.forEach((w, P) => Gt(w, t && (V(t) ? t[P] : t), n, s, r))
    return
  }
  if (Kt(s) && !r) {
    s.shapeFlag & 512 &&
  ...
  const i = s.shapeFlag & 4 ? Rs(s.component) : s.el,
    ...
    m = d === X ? Er : (w) => k(g, w)
  if (h != null && h !== c) {
    if ((Ms(t), re(h))) ((u[h] = null), m(h) && (d[h] = null))
    else if (ce(h)) {
      h.value = null
      const w = t
      w.k && (u[w.k] = null)
  ...
  if (B(c)) en(c, l, 12, [o, u])
    ...
    if (w || P) {
      const j = () => {
        if (e.f) {
          const N = w ? (m(c) ? d[c] : u[c]) : c.value
          if (r) V(N) && os(N, i)
          else if (V(N)) N.includes(i) || N.push(i)
          else if (w) ((u[c] = [i]), m(c) && (d[c] = u[c]))
          else {
            const T = [i]
            ;((c.value = T), e.k && (u[e.k] = T))
          }
        } else w ? ((u[c] = o), m(c) && (d[c] = o)) : P && ((c.value = o), e.k && (u[e.k] = o))
      }
      if (o) {
        const N = () => {
          ;(j(), pn.delete(e))
...
const Jn = (e) => (e ? (Ei(e) ? Rs(e) : Jn(e.parent)) : null),
...
function tl(e) {
  const t = ni(e),
    n = e.proxy,
    s = e.ctx
  ;((zn = !1), t.beforeCreate && Fs(t.beforeCreate, e, 'bc'))
  const {
    data: r,
    computed: i,
    methods: o,
  ...
  if (((zn = !0), i))
    for (const J in i) {
      const K = i[J],
        Ue = B(K) ? K.bind(n, n) : B(K.get) ? K.get.bind(n, n) : Ve,
        Ze = !B(K) && B(K.set) ? K.set.bind(n) : Ve,
        Ie = Re({ get: Ue, set: Ze })
  ...
  if (l) for (const J in l) ti(l[J], s, n, J)
  if (c) {
  ...
  u && Fs(u, e, 'c')
  function se(J, K) {
    V(K) ? K.forEach((Ue) => J(Ue.bind(n))) : K && J(K.bind(n))
  }
  if (
    (se(Uo, d),
    se(Go, g),
    ...
    if (Pe.length) {
      ...
      Pe.forEach((K) => {
        Object.defineProperty(J, K, { get: () => n[K], set: (Ue) => (n[K] = Ue), enumerable: !0 })
      })
    } else e.exposed || (e.exposed = {})
  ;(z && e.render === Ve && (e.render = z),
...
function Bs(e, t) {
  return e
    ? V(e) && V(t)
      ? [...new Set([...e, ...t])]
      : fe(Object.create(null), Ls(e), Ls(t ?? {}))
    : t
}
function il(e, t) {
  if (!e) return t
...
function ll(e, t) {
  return function (s, r = null) {
    ...
    const h = (i.app = {
      ...
      unmount() {
        c && (je(l, h._instance, 16), e(null, h._container), delete h._container.__vue_app__)
      },
      provide(u, d) {
...
function fl(e, t, ...n) {
  ...
  const i = t.startsWith('update:'),
    o = i && cl(s, t.slice(7))
  o && (o.trim && (r = n.map((u) => (re(u) ? u.trim() : u))), o.number && (r = n.map(qi)))
  let l,
    c = s[(l = Tn(t))] || s[(l = Tn(xe(t)))]
  ;(!c && i && (c = s[(l = Tn(mt(t)))]), c && je(c, e, 6, r))
  const h = s[l + 'Once']
  if (h) {
    if (!e.emitted) e.emitted = {}
    else if (e.emitted[l]) return
    ;((e.emitted[l] = !0), je(h, e, 6, r))
  }
}
const ul = new WeakMap()
function ri(e, t, n = !1) {
  const s = n ? ul : t.emitsCache,
    r = s.get(e)
  ...
  return !i && !l
    ...
    : (V(i) ? i.forEach((c) => (o[c] = null)) : fe(o, i), te(e) && s.set(e, o), o)
}
function wn(e, t) {
  return !e || !yn(t)
    ? !1
...
function Vs(e) {
  ...
  try {
    if (n.shapeFlag & 4) {
      const I = r || s,
        z = I
      ;((N = Be(h.call(z, I, u, d, m, g, w))), (T = l))
    } else {
      const I = t
      ;((N = Be(I.length > 1 ? I(d, { attrs: l, slots: o, emit: c }) : I(d, null))),
        (T = t.props ? l : al(l)))
    }
  } catch (I) {
  ...
  if (T && P !== !1) {
    const I = Object.keys(T),
      { shapeFlag: z } = L
    I.length && z & 7 && (i && I.some(is) && (T = dl(T, i)), (L = Ot(L, T, !1, !0)))
  }
  return (
    n.dirs && ((L = Ot(L, null, !1, !0)), (L.dirs = L.dirs ? L.dirs.concat(n.dirs) : n.dirs)),
    n.transition && ys(L, n.transition),
    (N = L),
    hn(j),
    N
  )
...
const ii = {},
  oi = () => Object.create(ii),
  li = (e) => Object.getPrototypeOf(e) === ii
function gl(e, t, n, s = !1) {
  const r = {},
    i = oi()
  ;((e.propsDefaults = Object.create(null)), ci(e, t, r, i))
  for (const o in e.propsOptions[0]) o in r || (r[o] = void 0)
  ;(n ? (e.props = s ? r : Vr(r)) : e.type.props ? (e.props = r) : (e.props = i), (e.attrs = i))
}
function ml(e, t, n, s) {
  const {
      props: r,
  ...
  if ((s || o > 0) && !(o & 16)) {
    ...
    let u
    for (const d in l)
      (!t || (!k(t, d) && ((u = mt(d)) === d || !k(t, u)))) &&
        (c
          ? n && (n[d] !== void 0 || n[u] !== void 0) && (r[d] = Yn(c, l, d, void 0, e, !0))
          : delete r[d])
  ...
  if (V(i))
    ...
    for (const u in i) {
      ...
      if (Us(d)) {
        ...
        else P = B(w) && w.name === 'Boolean'
        ;((m[0] = P), (m[1] = j), (P || k(m, 'default')) && l.push(d))
      }
    }
  const h = [o, l]
...
const bs = (e) => e === '_' || e === '_ctx' || e === '$stable',
  ...
  yl = (e, t, n) => {
    ...
    if (e.vnode.shapeFlag & 32) {
      const r = t._
      r ? (di(s, t, n), n && Rr(s, '_', r, !0)) : ui(t, s)
    } else t && ai(e, t)
  },
  bl = (e, t, n) => {
    ...
    if (s.shapeFlag & 32) {
      const l = t._
      ;(l ? (n && l === 1 ? (i = !1) : di(r, t, n)) : ((i = !t.$stable), ui(t, r)), (o = t))
...
function xl(e, t) {
  ...
  const {
    ...
    P = (f, a, p, _ = null, b = null, v = null, A = void 0, R = null, x = !!a.dynamicChildren) => {
      if (f === a) return
      ;(f && !Lt(f, a) && ((_ = y(f)), pe(f, b, v, !0), (f = null)),
        a.patchFlag === -2 && ((x = !1), (a.dynamicChildren = null)))
      const { type: E, ref: F, shapeFlag: C } = a
      switch (E) {
        case On:
          j(f, a, p, _)
          break
        ...
        case cn:
          ...
          break
        case He:
          ft(f, a, p, _, b, v, A, R, x)
          break
        default:
          C & 1
            ? z(f, a, p, _, b, v, A, R, x)
            : C & 6
              ? Te(f, a, p, _, b, v, A, R, x)
              : (C & 64 || C & 128) && E.process(f, a, p, _, b, v, A, R, x, M)
      }
      F != null && b
        ? Gt(F, f && f.ref, v, a || f, !a)
        : F == null && f && f.ref != null && Gt(f.ref, null, v, f, !0)
    },
    j = (f, a, p, _) => {
      if (f == null) s((a.el = l(a.children)), p, _)
      else {
        const b = (a.el = f.el)
        a.children !== f.children && h(b, a.children)
      }
    },
    N = (f, a, p, _) => {
    ...
    T = (f, a, p, _) => {
      ;[f.el, f.anchor] = w(f.children, a, p, _, f.el, f.anchor)
    },
    L = ({ el: f, anchor: a }, p, _) => {
      let b
    ...
    z = (f, a, p, _, b, v, A, R, x) => {
      if ((a.type === 'svg' ? (A = 'svg') : a.type === 'math' && (A = 'mathml'), f == null))
        ie(a, p, _, b, v, A, R, x)
      else {
        const E = f.el && f.el._isVueCE ? f.el : null
        try {
          ;(E && E._beginPatch(), Ye(f, a, b, v, A, R, x))
        } finally {
          E && E._endPatch()
        }
      }
    ...
    ie = (f, a, p, _, b, v, A, R) => {
      let x, E
      const { props: F, shapeFlag: C, transition: D, dirs: H } = f
      if (
        ((x = f.el = o(f.type, v, F && F.is, F)),
        C & 8 ? u(x, f.children) : C & 16 && Oe(f.children, x, null, _, b, Fn(f, v), A, R),
        H && at(f, null, _, 'created'),
        Z(x, f, f.scopeId, A, _),
        F)
      ) {
        for (const Q in F) Q !== 'value' && !Vt(Q) && i(x, Q, null, F[Q], v, _)
        ;('value' in F && i(x, 'value', null, F.value, v),
          (E = F.onVnodeBeforeMount) && Le(E, _, f))
      }
      ...
      ;(G && D.beforeEnter(x),
        ...
        ((E = F && F.onVnodeMounted) || G || H) &&
          ye(() => {
            ;(E && Le(E, _, f), G && D.enter(x), H && at(f, null, _, 'mounted'))
          }, b))
    },
    Z = (f, a, p, _, b) => {
      ...
      if (b) {
        let v = b.subTree
        if (a === v || (mi(v.type) && (v.ssContent === a || v.ssFallback === a))) {
          const A = b.vnode
          Z(f, A, A.scopeId, A.slotScopeIds, b.parent)
        }
      }
    },
    Oe = (f, a, p, _, b, v, A, R, x = 0) => {
      for (let E = x; E < f.length; E++) {
        const F = (f[E] = R ? st(f[E]) : Be(f[E]))
    ...
    Ye = (f, a, p, _, b, v, A) => {
      ...
      if (
        (p && dt(p, !1),
        (H = D.onVnodeBeforeUpdate) && Le(H, p, a, f),
        F && at(a, f, p, 'beforeUpdate'),
        p && dt(p, !0),
        ((C.innerHTML && D.innerHTML == null) || (C.textContent && D.textContent == null)) &&
          u(R, ''),
        E
          ? Pe(f.dynamicChildren, E, R, p, _, Fn(a, b), v)
          : A || K(f, a, R, null, p, _, Fn(a, b), v, !1),
        x > 0)
      ) {
        if (x & 16) Xe(R, C, D, p, b)
        else if (
          (x & 2 && C.class !== D.class && i(R, 'class', null, D.class, b),
          x & 4 && i(R, 'style', C.style, D.style, b),
          x & 8)
        ) {
        ...
        x & 1 && f.children !== a.children && u(R, a.children)
      } else !A && E == null && Xe(R, C, D, p, b)
      ;((H = D.onVnodeUpdated) || F) &&
        ye(() => {
          ;(H && Le(H, p, a, f), F && at(a, f, p, 'updated'))
        }, _)
    },
    Pe = (f, a, p, _, b, v, A) => {
      for (let R = 0; R < a.length; R++) {
        const x = f[R],
          E = a[R],
          F = x.el && (x.type === He || !Lt(x, E) || x.shapeFlag & 198) ? d(x.el) : p
        P(x, E, F, null, _, b, v, A, !0)
      }
    },
    Xe = (f, a, p, _, b) => {
      if (a !== p) {
        if (a !== X) for (const v in a) !Vt(v) && !(v in p) && i(f, v, a[v], null, b, _)
        for (const v in p) {
          if (Vt(v)) continue
          const A = p[v],
            R = a[v]
          A !== R && v !== 'value' && i(f, v, R, A, b, _)
        }
        'value' in p && i(f, 'value', a.value, p.value, b)
      }
    },
    ft = (f, a, p, _, b, v, A, R, x) => {
      const E = (a.el = f ? f.el : l('')),
        F = (a.anchor = f ? f.anchor : l(''))
      let { patchFlag: C, dynamicChildren: D, slotScopeIds: H } = a
      ;(H && (R = R ? R.concat(H) : H),
        f == null
          ? (s(E, p, _), s(F, p, _), Oe(a.children || [], p, F, b, v, A, R, x))
          : C > 0 && C & 64 && D && f.dynamicChildren && f.dynamicChildren.length === D.length
            ? (Pe(f.dynamicChildren, D, p, b, v, A, R),
              (a.key != null || (b && a === b.subTree)) && hi(f, a, !0))
            : K(f, a, p, F, b, v, A, R, x))
    },
    Te = (f, a, p, _, b, v, A, R, x) => {
      ;((a.slotScopeIds = R),
    ...
    Nt = (f, a, p, _, b, v, A) => {
      const R = (f.component = Ll(f, _, b))
      if ((Xr(f) && (R.ctx.renderer = M), Hl(R, !1, A), R.asyncDep)) {
        if ((b && b.registerDep(R, se, A), !f.el)) {
          const x = (R.subTree = he(ct))
          ;(N(null, x, a, p), (f.placeholder = x.el))
        }
      } else se(R, f, a, p, b, v, A)
    },
    _t = (f, a, p) => {
    ...
    se = (f, a, p, _, b, v, A) => {
      const R = () => {
        if (f.isMounted) {
          let { next: C, bu: D, u: H, parent: G, vnode: Q } = f
          {
            const Me = pi(f)
            if (Me) {
              ;(C && ((C.el = Q.el), J(f, C, A)),
          ...
          let $ = C,
            ge
          ;(dt(f, !1),
            C ? ((C.el = Q.el), J(f, C, A)) : (C = Q),
            D && In(D),
            (ge = C.props && C.props.onVnodeBeforeUpdate) && Le(ge, G, C, Q),
            dt(f, !0))
          const me = Vs(f),
            Ne = f.subTree
          ;((f.subTree = me),
            P(Ne, me, d(Ne.el), y(Ne), f, b, v),
            (C.el = me.el),
            $ === null && pl(f, me.el),
            H && ye(H, b),
            (ge = C.props && C.props.onVnodeUpdated) && ye(() => Le(ge, G, C, Q), b))
        } else {
          let C
          const { el: D, props: H } = a,
            { bm: G, m: Q, parent: $, root: ge, type: me } = f,
            Ne = Kt(a)
          ;(dt(f, !1), G && In(G), !Ne && (C = H && H.onVnodeBeforeMount) && Le(C, $, a), dt(f, !0))
          {
            ge.ce && ge.ce._def.shadowRoot !== !1 && ge.ce._injectChildStyle(me)
            const Me = (f.subTree = Vs(f))
            ;(P(null, Me, p, _, f, b, v), (a.el = Me.el))
          }
          if ((Q && ye(Q, b), !Ne && (C = H && H.onVnodeMounted))) {
            const Me = a
            ye(() => Le(C, $, Me), b)
          }
      ...
      f.scope.on()
      const x = (f.effect = new Sr(R))
      f.scope.off()
      const E = (f.update = x.run.bind(x)),
        F = (f.job = x.runIfDirty.bind(x))
      ;((F.i = f), (F.id = f.uid), (x.scheduler = () => vs(F)), dt(f, !0), E())
    },
    J = (f, a, p) => {
      a.component = f
    ...
    K = (f, a, p, _, b, v, A, R, x = !1) => {
      ...
      if (D > 0) {
        if (D & 128) {
          Ze(E, C, p, _, b, v, A, R, x)
          return
        } else if (D & 256) {
          Ue(E, C, p, _, b, v, A, R, x)
          return
        }
      }
      H & 8
        ? (F & 16 && Ee(E, b, v), C !== E && u(p, C))
        : F & 16
          ? H & 16
            ? Ze(E, C, p, _, b, v, A, R, x)
            : Ee(E, b, v, !0)
          : (F & 8 && u(p, ''), H & 16 && Oe(C, p, _, b, v, A, R, x))
    },
    Ue = (f, a, p, _, b, v, A, R, x) => {
      ;((f = f || Rt), (a = a || Rt))
      const E = f.length,
        F = a.length,
        C = Math.min(E, F)
      let D
      for (D = 0; D < C; D++) {
        const H = (a[D] = x ? st(a[D]) : Be(a[D]))
        P(f[D], H, p, null, b, v, A, R, x)
      }
      E > F ? Ee(f, b, v, !0, !1, C) : Oe(a, p, _, b, v, A, R, x, C)
    },
    Ze = (f, a, p, _, b, v, A, R, x) => {
      let E = 0
      const F = a.length
      let C = f.length - 1,
        D = F - 1
      for (; E <= C && E <= D; ) {
        const H = f[E],
          G = (a[E] = x ? st(a[E]) : Be(a[E]))
        if (Lt(H, G)) P(H, G, p, null, b, v, A, R, x)
        else break
        E++
      }
      for (; E <= C && E <= D; ) {
        const H = f[C],
          G = (a[D] = x ? st(a[D]) : Be(a[D]))
        if (Lt(H, G)) P(H, G, p, null, b, v, A, R, x)
        else break
        ;(C--, D--)
      }
      if (E > C) {
        if (E <= D) {
          const H = D + 1,
            G = H < F ? a[H].el : _
          for (; E <= D; ) (P(null, (a[E] = x ? st(a[E]) : Be(a[E])), p, G, b, v, A, R, x), E++)
        }
      } else if (E > D) for (; E <= C; ) (pe(f[E], b, v, !0), E++)
      else {
        const H = E,
          G = E,
          Q = new Map()
        for (E = G; E <= D; E++) {
          const ve = (a[E] = x ? st(a[E]) : Be(a[E]))
        ...
        for (E = H; E <= C; E++) {
          ...
          let De
          if (ve.key != null) De = Q.get(ve.key)
          else
            for ($ = G; $ <= D; $++)
              if (Mt[$ - G] === 0 && Lt(ve, a[$])) {
                De = $
        ...
        const Cs = Ne ? Al(Mt) : Rt
        for ($ = Cs.length - 1, E = me - 1; E >= 0; E--) {
          const ve = G + E,
            De = a[ve],
            ws = a[ve + 1],
            Os = ve + 1 < F ? ws.el || gi(ws) : _
          Mt[E] === 0
            ? P(null, De, p, Os, b, v, A, R, x)
            : Ne && ($ < 0 || E !== Cs[$] ? Ie(De, p, Os, 2) : $--)
        }
      }
    },
    Ie = (f, a, p, _, b = null) => {
      const { el: v, type: A, transition: R, children: x, shapeFlag: E } = f
      if (E & 6) {
        Ie(f.component.subTree, a, p, _)
        return
      }
      if (E & 128) {
      ...
      if (A === He) {
        s(v, a, p)
        for (let C = 0; C < x.length; C++) Ie(x[C], a, p, _)
        s(f.anchor, a, p)
        return
      }
      if (A === cn) {
      ...
      if (_ !== 2 && E & 1 && R)
        if (_ === 0) (R.beforeEnter(v), s(v, a, p), ye(() => R.enter(v), b))
          ...
          const { leave: C, delayLeave: D, afterLeave: H } = R,
            G = () => {
    ...
    pe = (f, a, p, _ = !1, b = !1) => {
      ...
      const G = F & 1 && D,
        Q = !Kt(f)
      let $
      if ((Q && ($ = A && A.onVnodeBeforeUnmount) && Le($, a, f), F & 6)) ut(f.component, p, _)
      else {
        if (F & 128) {
          f.suspense.unmount(p, _)
          return
        }
        ;(G && at(f, null, a, 'beforeUnmount'),
          F & 64
            ? f.type.remove(f, a, p, M, _)
            : E && !E.hasOnce && (v !== He || (C > 0 && C & 64))
              ? Ee(E, a, p, !1, !0)
              : ((v === He && C & 384) || (!b && F & 16)) && Ee(x, a, p),
          _ && vt(f))
      }
      ;((Q && ($ = A && A.onVnodeUnmounted)) || G) &&
        ye(() => {
          ;($ && Le($, a, f), G && at(f, null, a, 'unmounted'))
        }, p)
    },
    vt = (f) => {
    ...
    ut = (f, a, p) => {
      const { bum: _, scope: b, job: v, subTree: A, um: R, m: x, a: E } = f
      ;(Gs(x),
        Gs(E),
        _ && In(_),
        b.stop(),
        v && ((v.flags |= 8), pe(A, f, a, p)),
        R && ye(R, a),
        ye(() => {
          f.isUnmounted = !0
        }, a))
    },
    Ee = (f, a, p, _ = !1, b = !1, v = 0) => {
      for (let A = v; A < f.length; A++) pe(f[A], a, p, _, b)
    },
    y = (f) => {
  ...
  const S = (f, a, p) => {
      ...
      ;(f == null
        ...
        : P(a._vnode || null, f, a, null, null, null, p),
        (a._vnode = f),
        O || ((O = !0), Ns(_), qr(), (O = !1)))
    },
    M = { p: P, um: pe, m: Ie, r: vt, mt: Nt, mc: Oe, pc: K, pbc: Pe, n: y, o: e }
  return { render: S, hydrate: void 0, createApp: ll(S) }
}
  ...
  if (V(s) && V(r))
    for (let i = 0; i < s.length; i++) {
      ...
      ;(l.shapeFlag & 1 &&
        ...
        l.type === On &&
          (l.patchFlag !== -1 ? (l.el = o.el) : (l.__elIndex = i + (e.type === He ? 1 : 0))),
...
function wl(e, t, n, s, r, i) {
  return vi(bi(e, t, n, s, r, i, !0))
}
function Ol(e, t, n, s, r) {
  return vi(he(e, t, n, s, r, !0))
}
function _n(e) {
...
function bi(e, t = null, n = null, s = 0, r = null, i = e === He ? 0 : 1, o = !1, l = !1) {
  const c = {
    __v_isVNode: !0,
    __v_skip: !0,
    type: e,
  ...
  return (
    l ? (xs(c, n), i & 128 && e.normalize(c)) : n && (c.shapeFlag |= re(n) ? 8 : 16),
...
function Pl(e, t = null, n = null, s = 0, r = null, i = !1) {
  ...
  if ((Gl(e) && (e = e.__vccOpts), t)) {
    ...
    ;(l && !re(l) && (t.class = fs(l)),
      te(c) && (_s(c) && !V(c) && (c = fe({}, c)), (t.style = cs(c))))
  }
  const o = re(e) ? 1 : mi(e) ? 128 : Fo(e) ? 64 : te(e) ? 4 : B(e) ? 2 : 0
  return bi(e, t, n, s, r, o, i, !0)
}
function Tl(e) {
  return e ? (_s(e) || li(e) ? fe({}, e) : e) : null
}
function Ot(e, t, n = !1, s = !1) {
  const { props: r, ref: i, patchFlag: o, children: l, transition: c } = e,
    ...
    u = {
      ...
      props: h,
      key: h && yi(h),
      ref: t && t.ref ? (n && i ? (V(i) ? i.concat(fn(t)) : [i, fn(t)]) : fn(t)) : i,
      scopeId: e.scopeId,
...
let vn, Xn
{
  ...
  ;((vn = t('__VUE_INSTANCE_SETTERS__', (n) => (le = n))),
    (Xn = t('__VUE_SSR_SETTERS__', (n) => (Xt = n))))
}
const tn = (e) => {
    const t = le
    return (
...
function Rs(e) {
  return e.exposed
    ? e.exposeProxy ||
        (e.exposeProxy = new Proxy(Ur(yo(e.exposed)), {
          get(t, n) {
...
if (qs)
  try {
    Zn = qs.createPolicy('vue', { createHTML: (e) => e })
  } catch {}
const Ai = Zn ? (e) => Zn.createHTML(e) : (e) => e,
  Wl = 'http://www.w3.org/2000/svg',
  ql = 'http://www.w3.org/1998/Math/MathML',
  We = typeof document < 'u' ? document : null,
  ks = We && We.createElement('template'),
  kl = {
    insert: (e, t, n) => {
...
function Xl(e, t, n) {
  ...
  $s in e && ((e[$s] = i ? s.display : ''), e[zl] && (s.display = 'none'))
}
const Js = /\s*!important$/
function un(e, t, n) {
  if (V(n)) n.forEach((s) => un(e, t, s))
  else if ((n == null && (n = ''), t.startsWith('--'))) e.setProperty(t, n)
  else {
    const s = Zl(e, t)
    Js.test(n) ? e.setProperty(mt(s), n.replace(Js, ''), 'important') : (e[s] = n)
  }
}
...
const rc = Promise.resolve(),
  ic = () => Bn || (rc.then(() => (Bn = 0)), (Bn = Date.now()))
function oc(e, t) {
  const n = (s) => {
    if (!s._vts) s._vts = Date.now()
    else if (s._vts <= n.attached) return
    je(lc(s, n.value), t, 5, [s])
  }
...
const gc = (e, t) => {
  ...
  _c = { id: 'app-root' }
function vc(e, t) {
  const n = Yo('router-view')
  return (_i(), wl('div', _c, [he(n)]))
}
const yc = gc(mc, [['render', vc]]),
  bc = 'modulepreload',
  Ec = function (e) {
    return '/' + e
  },
          ...
          if (
            ...
            return new Promise((m, w) => {
              ;(g.addEventListener('load', m),
                g.addEventListener('error', () => w(new Error(`Unable to preload CSS for ${h}`))))
            })
        }),
      )
    }
...
function Nc(e) {
  return As(e).replace(Pi, '{').replace(Ti, '}').replace(Oi, '^')
}
function es(e) {
  return As(e)
    .replace(wi, '%2B')
...
function Mc(e) {
  return es(e).replace(Sc, '%3D')
}
function Dc(e) {
  return As(e).replace(Ci, '%23').replace(Cc, '%3F')
}
function Lc(e) {
  return Dc(e).replace(Ac, '%2F')
}
function Zt(e) {
...
function Ii(e, t) {
  ...
  for (var n in e) if (!jc(e[n], t[n])) return !1
  return !0
}
function jc(e, t) {
  return we(e) ? lr(e, t) : we(t) ? lr(t, e) : e?.valueOf() === t?.valueOf()
}
function lr(e, t) {
  return we(t)
...
function Tt(e, t) {
  return W(new Error(), { type: e, [Mi]: !0 }, t)
}
function Ke(e, t) {
  return e instanceof Error && Mi in e && (t == null || !!(e.type & t))
}
const Qc = ['params', 'query', 'hash']
function Yc(e) {
  if (typeof e == 'string') return e
  if (e.path != null) return e.path
  const t = {}
  for (const n of Qc) n in e && (t[n] = e[n])
...
function fr(e) {
  ...
  for (let n in e) {
    ...
    ;(we(s) ? s.map((r) => r && es(r)) : [s && es(s)]).forEach((r) => {
...
function Zc(e) {
  ...
  for (const n in e) {
    const s = e[n]
    s !== void 0 &&
      (t[n] = we(s) ? s.map((r) => (r == null ? null : '' + r)) : s == null ? s : '' + s)
  }
  return t
}
const ef = Symbol(''),
  ...
  const l = ({ state: g }) => {
    ...
    r.forEach((N) => {
      N(n.value, w, {
        delta: j,
        type: ts.pop,
        direction: j ? (j > 0 ? Un.forward : Un.back) : Un.unknown,
      })
    })
  }
  function c() {
...
function rf(e) {
  ...
  function i(c, h, u) {
    const d = e.indexOf('#'),
      g = d > -1 ? (n.host && document.querySelector('base') ? e : e.slice(d)) + c : nf() + e + c
    try {
      ;(t[u ? 'replaceState' : 'pushState'](h, '', g), (r.value = h))
    } catch (m) {
  ...
  function l(c, h) {
    const u = W({}, r.value, t.state, { forward: c, scroll: Pn() })
    ;(i(u.current, u, !0),
      i(c, W({}, ar(s.value, c, null), { position: u.position + 1 }, h), !1),
      (s.value = c))
  }
...
function of(e) {
  ...
  const r = W({ location: '', base: e, go: s, createHref: Wc.bind(null, e) }, t, n)
  return (
...
function hf(e, t) {
  ...
  const i = []
  for (const h of e) {
    const u = h.length ? [] : [ae.Root]
    n.strict && !h.length && (r += '/')
    for (let d = 0; d < h.length; d++) {
      const g = h[d]
      let m = ae.Segment + (n.sensitive ? ae.BonusCaseSensitive : 0)
      if (g.type === pt.Static)
        (d || (r += '/'), (r += g.value.replace(df, '\\$&')), (m += ae.Static))
      else if (g.type === pt.Param) {
        const { value: w, repeatable: P, optional: j, regexp: N } = g
        i.push({ name: w, repeatable: P, optional: j })
        const T = N || dr
        if (T !== dr) {
          ...
          try {
            ...
            throw new Error(`Invalid custom RegExp for param "${w}" (${T}): ` + I.message)
          }
        }
        let L = P ? `((?:${T})(?:/(?:${T}))*)` : `(${T})`
  ...
  function l(h) {
    ...
    for (let g = 1; g < u.length; g++) {
      const m = u[g] || '',
        w = i[g - 1]
      d[w.name] = m && w.repeatable ? m.split('/') : m
    }
    return d
  }
  function c(h) {
    ...
    for (const g of e) {
      ...
      for (const m of g)
        if (m.type === pt.Static) u += m.value
          ...
          const { value: w, repeatable: P, optional: j } = m,
            N = w in h ? h[w] : ''
          if (we(N) && !P)
            throw new Error(
              `Provided param "${w}" is an array but it is not repeatable (* or + modifiers)`,
            )
          const T = we(N) ? N.join('/') : N
          if (!T)
            if (j) g.length < 2 && (u.endsWith('/') ? (u = u.slice(0, -1)) : (d = !0))
  ...
  function i(d, g, m) {
    ...
    for (const I of N) {
      ...
      if (
        ...
        m
          ? m.alias.push(T)
          : ((L = L || T), L !== T && L.alias.push(T), w && d.name && !mr(T) && o(d.name)),
        Hi(T) && c(T),
        P.children)
      ) {
        const ie = P.children
...
function _r(e) {
  const t = ke(Ss),
    ...
    r = Re(() => {
      ...
      const g = d.findIndex(Pt.bind(null, u))
      if (g > -1) return g
      const m = vr(c[h - 2])
      return h > 1 && vr(u) === m && d[d.length - 1].path !== m
        ? d.findIndex(Pt.bind(null, c[h - 2]))
        : g
    }),
    i = Re(() => r.value > -1 && Cf(n.params, s.value.params)),
    o = Re(() => r.value > -1 && r.value === n.matched.length - 1 && Ii(n.params, s.value.params))
  function l(c = {}) {
    if (Sf(c)) {
...
const Rf = Qr({
    ...
    setup(e, { slots: t }) {
      ...
      return () => {
        const i = t.default && xf(t.default(n))
        return e.custom
          ? i
          : Ri(
              'a',
...
function Cf(e, t) {
  for (const n in t) {
    ...
    if (typeof s == 'string') {
      if (s !== r) return !1
    } else if (!we(r) || r.length !== s.length || s.some((i, o) => i.valueOf() !== r[o].valueOf()))
      return !1
  }
  return !0
}
        ...
        ln(
          ...
          ([h, u, d], [g, m, w]) => {
            ;(u &&
              ...
              h && u && (!m || !Pt(u, m) || !g) && (u.enterCallbacks[d] || []).forEach((P) => P(h)))
          },
          { flush: 'post' },
        ),
        () => {
          ...
          const m = d.props[u],
            w = m ? (m === !0 ? h.params : typeof m == 'function' ? m(h) : m) : null,
            j = Ri(
              g,
              W({}, w, t, {
                onVnodeUnmounted: (N) => {
...
function Pf(e) {
  ...
  const u = Vn.bind(null, (y) => '' + y),
    d = Vn.bind(null, Lc),
    g = Vn.bind(null, Zt)
  function m(y, O) {
    let S, M
    return (Ni(y) ? ((S = t.getRecordMatcher(y)), (M = O)) : (M = y), t.addRoute(M, S))
  }
  function w(y) {
  ...
  function N(y, O) {
    ...
    let S
    if (y.path != null) S = W({}, y, { path: jn(n, y.path, O.path).path })
    else {
      const p = W({}, y.params)
      for (const _ in p) p[_] == null && delete p[_]
      ;((S = W({}, y, { params: d(p) })), (O.params = d(O.params)))
    }
    const M = t.resolve(S, O),
      U = y.hash || ''
    M.params = u(g(M.params))
    const f = Bc(s, W({}, y, { hash: Nc(U), path: M.path })),
      a = r.createHref(f)
    return W({ fullPath: f, hash: U, query: s === fr ? Zc(y.query) : y.query || {} }, M, {
      redirectedFrom: void 0,
      href: a,
    })
  }
  function T(y) {
    return typeof y == 'string' ? jn(n, y, c.value.path) : W({}, y)
  }
  function L(y, O) {
    if (h !== y) return Tt(ee.NAVIGATION_CANCELLED, { from: O, to: y })
  }
  function I(y) {
    return Z(y)
  }
  ...
  function Z(y, O) {
    ...
    if (p)
      return Z(
        W(T(p), { state: typeof p == 'object' ? W({}, U, p.state) : U, force: f, replace: a }),
        O || S,
      )
    const _ = S
    _.redirectedFrom = O
    ...
    return (
      !f &&
        Vc(s, M, S) &&
        ((b = Tt(ee.NAVIGATION_DUPLICATED, { to: _, from: M })), Ie(M, M, !0, !1)),
      (b ? Promise.resolve(b) : Pe(_, M))
        .catch((v) => (Ke(v) ? (Ke(v, ee.NAVIGATION_GUARD_REDIRECT) ? v : Ze(v)) : K(v, _, M)))
        .then((v) => {
          if (v) {
            if (Ke(v, ee.NAVIGATION_GUARD_REDIRECT))
              return Z(
                W({ replace: a }, T(v.to), {
  ...
  function Pe(y, O) {
    let S
    const [M, U, f] = tf(y, O)
    S = Gn(M.reverse(), 'beforeRouteLeave', y, O)
    for (const p of M)
    ...
    return (
      ...
      Ee(S)
        .then(() => {
          S = []
          for (const p of i.list()) S.push(rt(p, y, O))
          return (S.push(a), Ee(S))
        })
        .then(() => {
          S = Gn(U, 'beforeRouteUpdate', y, O)
          for (const p of U)
        ...
        .then(() => {
          ...
          for (const p of f)
            if (p.beforeEnter)
              if (we(p.beforeEnter)) for (const _ of p.beforeEnter) S.push(rt(_, y, O))
              else S.push(rt(p.beforeEnter, y, O))
          return (S.push(a), Ee(S))
        })
        .then(
          () => (
            y.matched.forEach((p) => (p.enterCallbacks = {})),
            (S = Gn(f, 'beforeRouteEnter', y, O, Ye)),
            S.push(a),
            Ee(S)
          ),
        )
        .then(() => {
          S = []
          for (const p of o.list()) S.push(rt(p, y, O))
          return (S.push(a), Ee(S))
        })
        .catch((p) => (Ke(p, ee.NAVIGATION_CANCELLED) ? p : Promise.reject(p)))
    )
  }
  function Xe(y, O, S) {
    l.list().forEach((M) => Ye(() => M(y, O, S)))
  }
  function ft(y, O, S, M, U) {
    const f = L(y, O)
    if (f) return f
    const a = O === et,
      p = xt ? history.state : {}
  ...
  function Nt() {
    Te ||
      (Te = r.listen((y, O, S) => {
        ...
        h = M
        const f = c.value
        ;(xt && $c(cr(f.fullPath, S.delta), Pn()),
          Pe(M, f)
            .catch((a) =>
              Ke(a, ee.NAVIGATION_ABORTED | ee.NAVIGATION_CANCELLED)
                ? a
                : Ke(a, ee.NAVIGATION_GUARD_REDIRECT)
                  ? (Z(W(T(a.to), { force: !0 }), M)
                      .then((p) => {
                        Ke(p, ee.NAVIGATION_ABORTED | ee.NAVIGATION_DUPLICATED) &&
                          !S.delta &&
                          S.type === ts.pop &&
                          r.go(-1, !1)
                      })
                      .catch(kt),
                    Promise.reject())
                  : (S.delta && r.go(-S.delta, !1), K(a, M, f)),
            )
            .then((a) => {
              ;((a = a || ft(M, f, !1)),
                a &&
                  (S.delta && !Ke(a, ee.NAVIGATION_CANCELLED)
                    ? r.go(-S.delta, !1)
                    : S.type === ts.pop &&
                      Ke(a, ee.NAVIGATION_ABORTED | ee.NAVIGATION_DUPLICATED) &&
                      r.go(-1, !1)),
                Xe(M, f, a))
            })
            .catch(kt))
  ...
  function K(y, O, S) {
    Ze(y)
    const M = se.list()
    return (M.length ? M.forEach((U) => U(y, O, S)) : console.error(y), Promise.reject(y))
  }
  function Ue() {
    return J && c.value !== et
      ? Promise.resolve()
  ...
  function Ze(y) {
    return (J || ((J = !y), Nt(), _t.list().forEach(([O, S]) => (y ? S(y) : O())), _t.reset()), y)
  }
  function Ie(y, O, S, M) {
    const { scrollBehavior: U } = e
    if (!xt || !U) return Promise.resolve()
    const f =
      (!S && Jc(cr(y.fullPath, 0))) || ((M || !S) && history.state && history.state.scroll) || null
    return Kr()
      .then(() => U(y, O, f))
      .then((a) => a && kc(a))
      .catch((a) => K(a, y, O))
    ...
    ut = {
      ...
      install(y) {
        ;(y.component('RouterLink', Af),
          y.component('RouterView', Of),
          (y.config.globalProperties.$router = ut),
        ...
        const O = {}
        for (const M in et) Object.defineProperty(O, M, { get: () => c.value[M], enumerable: !0 })
        ;(y.provide(Ss, ut), y.provide(Di, Vr(O)), y.provide(ss, c))
        const S = y.unmount
        ;(yt.add(y),
          (y.unmount = function () {
            ;(yt.delete(y),
              yt.size < 1 &&
                ((h = et), Te && Te(), (Te = null), (c.value = et), (vt = !1), (J = !1)),
              S())
          }))
      },
    }
  function Ee(y) {
    return y.reduce((O, S) => O.then(() => Ye(S)), Promise.resolve())
  }
  return ut
}
const Tf = [
    { path: '/', redirect: '/template2' },
    {
      path: '/template1',
      name: 'Template1',
      component: () => rr(() => import('./index.CjbndfYQ.js'), __vite__mapDeps([0, 1, 2, 3])),
    },
    {
      path: '/template2',
      name: 'Template2',
      component: () => rr(() => import('./index.C3aBnMRy.js'), __vite__mapDeps([4, 1, 2, 5])),
    },
  ],
